# -*- coding: utf-8 -*-
from flask import Flask, render_template, session, request, jsonify, send_from_directory, Response, redirect
import random
...
# MAIN CHALLENGE URL
@app.route("/dino/scrambled-cards/subscribe")
def challenge():
    session.clear()
...
@app.route("/")
def home():
    return redirect("/dino/scrambled-cards/subscribe")
